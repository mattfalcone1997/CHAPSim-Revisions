   ...
   END MODULE
     ...
     END SUBROUTINE FISHPACK_POIS3D_INIT
...
!C
!C     GENERATE TRANSFORM ROOTS FOR Y DIRECTION
!C  
...
!***********************************************************************
     ...
     INTEGER(4) :: I, J, K, JJ
      ...
      DO I=1,L
         DO K=1,M
            DO J=1,NL
               FR(I,K,J) = RHSLLPHI_io_tmp(I,J,K)
            END DO
         END DO
      END DO     
...
!     RESTORE RHSLLPHI
      DO I=1,L
         DO K=1,M
            DO J=1,NL
               RHSLLPHI_io_tmp(I,J,K) = FR(I,K,J)
            END DO
         END DO
      END DO
